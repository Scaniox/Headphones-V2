...
## Overview
This application demonstrates an implementation of the Audio Sink (A2DP Sink) profile.

## Instructions
To demonstrate the app, follow these steps:

1. Build and download the application to the AIROC&#8482; board.( If using CYW943012BTEVK-01, must reboot the board before downloading the application)
2. The app will appear as an audio sink device, discoverable and connectable by default.
3. Audio source devices such as smartphones or the BTSDK watch app can discover the sink device, connect to it and start/stop streaming.
4. This app can also mute/unmute the streaming audio by pressing the CUSTOM button on the AIROC&#8482; board, except with 43012-related and 55572-related platform.
   For example, a2dp_sink with platform CYW920721M2EVK-02 can support mute/unmute button but with CYW9M2BASE-43012BT and CYW943012BTEVK-01 and CYW955572BTEVK-01 cannot.

## Application Settings
Application specific settings are as below:

- AAC\_SUPPORT
    - This option allows the device to enable the AAC codec if the Bluetooth&#174; chip supports. By default 55572A1 enables this option and 20721B2/43012C0 don't support it.
