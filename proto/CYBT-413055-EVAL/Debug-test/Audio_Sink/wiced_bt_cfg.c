...
const wiced_bt_cfg_ble_advert_settings_t wiced_bt_cfg_adv_settings =
{
    ...
    .high_duty_min_interval = WICED_BT_CFG_DEFAULT_HIGH_DUTY_DIRECTED_ADV_MIN_INTERVAL, /**< High duty undirected connectable minimum advertising interval */
...
#if ( ( defined(CYW20719B1) || defined(CYW20721B1) || defined(CYW20721B2) ) && (WICED_A2DP_EXT_CODEC == WICED_TRUE) )
