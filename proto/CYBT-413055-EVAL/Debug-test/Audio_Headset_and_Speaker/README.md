...
2. Press the pairing button to start pairing mode of the headset\_speaker.
3. Find and pair with the "HSPK" Bluetooth&#174; audio device from your phone.
4. Once the process is completed, stream music from your phone to the headset\_speaker app.

## Application Settings
Application specific settings are as below:

- SPEAKER
    - This option allows the device to enable output on an audio shield board to drive the external speaker on an EVK board if it is supported. By default the option is off. This option is not applicable for CYW9M2BASE-43012BT device.

- AAC\_SUPPORT
    - This option allows the device to enable the AAC codec if the Bluetooth&#174; chip supports. By default 20721B2/55572A1 enables this option and 43012C0 doesn't support it.

- Audio Insertion
    - This feature only support on 20721M2 EVKs, it allows the device to insert short custom audio message during Idle/A2DP/HFP.
...
<br/>
- On CYW955572BTEVK-01(3 buttons)<br/>
Button event: click/ long press/ hold<br/>
1. Custom: Play, Pause, Accept/ Reject, Discoverable/ -<br/>
2. Vol+: Volume up/ Next Track/ Voice recognition<br/>
3. Vol-: Volume down/ Last Track/ -<br/>
